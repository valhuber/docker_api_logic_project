...
==============================================================================
    ...
    This file starts the API Logic Server (v 6.04.06, December 21, 2022 17:23:11):
...
app_logger.info(f'Created December 21, 2022 17:23:11 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 6.04.06\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 6.04.06\n'
    if is_docker():
